...
namespace FreeShop.DAL.DAL
{
    ...
    public class OrderInitializer : System.Data.Entity.DropCreateDatabaseAlways<OrderContext>
    {
        ...
        protected override void Seed(OrderContext context)
        {
            ...
            {
                new User{ UserID = 1 ,NickName="Arexol"         ,FirstName="Alex", LastName="Serkin",Email = "E@A.ru",Region = "Sevastopol",Role = "YoungPadavan"},
                new User{ UserID = 2 ,NickName="bsesie71"       ,FirstName="x"  , LastName="S"     ,Email = "E@A.ru",Region = "Sevastopol",Role = "YoungPadavan"},
